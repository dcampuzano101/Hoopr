        ...
        <div className="biz-index-items-container">
          <div className="biz-index-item b1">
            ...
            <div className="row-2">
              ...
              <button className="b-borough" value="harlem" onClick={this.handleFilter}>{this.capitalizeWord(b1.neighborhood)}</button>
            </div>
          </div>
          ...
          <div className="biz-index-item b2">
            ...
            <div className="row-2">
              ...
              <button className="b-borough" value="west village" onClick={this.handleFilter}>{this.capitalizeWord(b2.neighborhood)}</button>
            </div>
          </div>
          ...
          <div className="biz-index-item b3">
            ...
            <div className="row-2">
              ...
              <button className="b-borough" value="lower-manhattan" onClick={this.handleFilter}>{this.capitalizeWord(b3.neighborhood)}</button>
            </div>
          </div>
        </div>
      </>
